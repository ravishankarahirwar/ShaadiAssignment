...
import com.shaadi.adapter.UserAdapter;
import com.shaadi.models.User;
import com.shaadi.user.UserContractor;
import com.shaadi.user.UserPresenter;

import java.util.List;


public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, UserContractor.View {
    ...
    public void showUserList(final List<User> users) {
        runOnUiThread(new Runnable() {
            @Override
            public void run() {
                UserAdapter countryAdapter = new UserAdapter(MainActivity.this, users);
    ...
    @Override
    public void showErrorOnUserLoad() {
